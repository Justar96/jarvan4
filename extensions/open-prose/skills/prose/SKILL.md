...
metadata: {"jar4":{"emoji":"🪶","homepage":"https://www.prose.md"}}
---
...
- **Task tool** in the upstream spec == Jar4 `sessions_spawn`
- **File I/O** == Jar4 `read`/`write`
- **Remote fetch** == Jar4 `web_fetch` (or `exec` with curl when POST is required)
