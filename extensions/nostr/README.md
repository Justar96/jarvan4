...
Nostr DM channel plugin for Jar4 using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Jar4. It enables your bot to:
...
# Configure jar4 to use local relay
