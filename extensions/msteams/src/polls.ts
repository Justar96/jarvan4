...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["jar4PollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["jar4", "pollId"]) ??
    readNestedString(value, ["jar4", "poll", "id"]) ??
    readNestedString(value, ["data", "jar4PollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "jar4", "pollId"]);
