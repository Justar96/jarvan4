...
const tlonOutbound: ChannelOutboundAdapter = {
  ...
  sendText: async ({ cfg, to, text, accountId, replyToId, threadId }) => {
    const account = resolveTlonAccount(cfg as Jar4Config, accountId ?? undefined);
...
export const tlonPlugin: ChannelPlugin = {
  ...
  config: {
    listAccountIds: (cfg) => listTlonAccountIds(cfg as Jar4Config),
    resolveAccount: (cfg, accountId) => resolveTlonAccount(cfg as Jar4Config, accountId ?? undefined),
  ...
  setup: {
    ...
    validateInput: ({ cfg, accountId, input }) => {
      ...
      const resolved = resolveTlonAccount(cfg as Jar4Config, accountId ?? undefined);
