...
### Changes
- Version alignment with core Jar4 release numbers.
...
### Highlights
- First public release of the @jar4/voice-call plugin.
...
- CLI: `jar4 voicecall` commands (call/start/continue/speak/end/status/tail/expose).
