...
import { removeAckReactionAfterReply, shouldAckReaction } from "jar4/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/jar4") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
