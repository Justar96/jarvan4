...
export CLAWDBOT_STATE_DIR="/tmp/jar4-test"
export CLAWDBOT_CONFIG_PATH="${CLAWDBOT_STATE_DIR}/jar4.json"
...
pnpm jar4 reset --scope config+creds+sessions --yes --non-interactive
...
pnpm jar4 uninstall --state --yes --non-interactive
