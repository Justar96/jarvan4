...
# Output:
# - dist/Jar4.app
# - dist/Jar4-<version>.zip
# - dist/Jar4-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Jar4-$VERSION.zip"
DMG="$ROOT_DIR/dist/Jar4-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Jar4-$VERSION.notary.zip"
