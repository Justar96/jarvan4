...
export function listBindings(cfg: Jar4Config): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: Jar4Config, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: Jar4Config) {
