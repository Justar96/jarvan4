...
export function resolveTtsConfig(cfg: Jar4Config): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.JAR4_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: Jar4Config): string | undefined {
