...
describe("browser config", () => {
  ...
  it("derives default ports from JAR4_GATEWAY_PORT when unset", () => {
    const prev = process.env.JAR4_GATEWAY_PORT;
    process.env.JAR4_GATEWAY_PORT = "19001";
    try {
      const resolved = resolveBrowserConfig(undefined);
      ...
      if (prev === undefined) {
        ...
        process.env.JAR4_GATEWAY_PORT = prev;
      }
    }
  });
