import type { BrowserConfig, BrowserProfileConfig, Jar4Config } from "../config/config.js";
import {
 ...
 *
 * Note: this is a Jar4 browser profile (routing config), not a Chrome user profile.
