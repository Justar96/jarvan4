...
const SANDBOX_EXAMPLES = {
  main: [
    ["jar4 sandbox list", "List all sandbox containers."],
    ["jar4 sandbox list --browser", "List only browser containers."],
    ["jar4 sandbox recreate --all", "Recreate all containers."],
    ["jar4 sandbox recreate --session main", "Recreate a specific session."],
    ["jar4 sandbox recreate --agent mybot", "Recreate agent containers."],
    ["jar4 sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["jar4 sandbox list", "List all sandbox containers."],
    ["jar4 sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["jar4 sandbox recreate --all", "Recreate all containers."],
    ["jar4 sandbox recreate --session main", "Recreate a specific session."],
    ["jar4 sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["jar4 sandbox recreate --browser --all", "Recreate only browser containers."],
    ["jar4 sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["jar4 sandbox explain", "Show effective sandbox config."],
    ["jar4 sandbox explain --session agent:main:main", "Explain a specific session."],
    ["jar4 sandbox explain --agent work", "Explain an agent sandbox."],
    ["jar4 sandbox explain --json", "JSON output."],
  ],
} as const;
