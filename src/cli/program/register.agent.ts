...
${formatHelpExamples([
  ['jar4 agent --to +15555550123 --message "status update"', "Start a new session."],
  ['jar4 agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'jar4 agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'jar4 agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['jar4 agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'jar4 agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['jar4 agents set-identity --agent main --name "Clawd" --emoji "🦞"', "Set name + emoji."],
  ["jar4 agents set-identity --agent main --avatar avatars/clawd.png", "Set avatar path."],
  ["jar4 agents set-identity --workspace ~/clawd --from-identity", "Load from IDENTITY.md."],
  [
    "jar4 agents set-identity --identity-file ~/clawd/IDENTITY.md --agent main",
