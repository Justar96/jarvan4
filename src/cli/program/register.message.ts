...
${formatHelpExamples([
  ['jar4 message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'jar4 message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'jar4 message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}
