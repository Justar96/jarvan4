...
export function registerStatusHealthSessionsCommands(program: Command) {
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["jar4 status", "Show channel health + session summary."],
          ["jar4 status --all", "Full diagnosis (read-only)."],
          ["jar4 status --json", "Machine-readable output."],
          ["jar4 status --usage", "Show model provider usage/quota snapshots."],
          [
            "jar4 status --deep",
            "Run channel probes (WA + Telegram + Discord + Slack + Signal).",
          ],
          ["jar4 status --deep --timeout 5000", "Tighten probe timeout."],
        ])}`,
    )
    .addHelpText(
      "after",
  ...
  program
    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["jar4 sessions", "List all sessions."],
          ["jar4 sessions --active 120", "Only last 2 hours."],
          ["jar4 sessions --json", "Machine-readable output."],
          ["jar4 sessions --store ./tmp/sessions.json", "Use a specific session store."],
        ])}\n\n${theme.muted(
