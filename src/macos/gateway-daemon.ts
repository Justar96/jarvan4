...
declare const __JAR4_VERSION__: string;
...
async function main() {
  if (hasFlag(args, "--version") || hasFlag(args, "-v")) {
    // Match `jar4 --version` behavior for Swift env/version checks.
