...
export function buildServiceEnvironment(params: {
  ...
  const profile = env.JAR4_PROFILE;
  ...
  return {
    ...
    JAR4_PROFILE: profile,
    JAR4_STATE_DIR: env.JAR4_STATE_DIR,
    JAR4_CONFIG_PATH: env.JAR4_CONFIG_PATH,
    JAR4_GATEWAY_PORT: String(port),
    JAR4_GATEWAY_TOKEN: token,
    JAR4_LAUNCHD_LABEL: resolvedLaunchdLabel,
    JAR4_SYSTEMD_UNIT: systemdUnit,
    JAR4_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    JAR4_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    JAR4_STATE_DIR: env.JAR4_STATE_DIR,
    JAR4_CONFIG_PATH: env.JAR4_CONFIG_PATH,
    JAR4_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    JAR4_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    JAR4_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    JAR4_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    JAR4_LOG_PREFIX: "node",
    JAR4_SERVICE_MARKER: NODE_SERVICE_MARKER,
    JAR4_SERVICE_KIND: NODE_SERVICE_KIND,
    JAR4_SERVICE_VERSION: VERSION,
  };
}
