...
export type ChannelAgentToolFactory = (params: { cfg?: Jar4Config }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: Jar4Config; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: Jar4Config }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: Jar4Config }) => boolean;
  supportsCards?: (params: { cfg: Jar4Config }) => boolean;
