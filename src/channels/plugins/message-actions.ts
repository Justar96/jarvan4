...
export function listChannelMessageActions(cfg: Jar4Config): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: Jar4Config): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: Jar4Config): boolean {
  for (const plugin of listChannelPlugins()) {
