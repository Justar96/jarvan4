...
import { ensureJar4CliOnPath } from "../infra/path-env.js";
...
const execHostEnforced = process.env.JAR4_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  process.env.JAR4_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
...
function ensureNodePathEnv(): string {
  ensureJar4CliOnPath({ pathEnv: process.env.PATH ?? "" });
