...
export const PLUGIN_MANIFEST_FILENAME = "jar4.plugin.json";
...
// package.json "jar4" metadata (used for onboarding/catalog)
...
export type Jar4PackageManifest = {
  extensions?: string[];
...
): Jar4PackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.jar4 ?? manifest[LEGACY_MANIFEST_KEY];
}
