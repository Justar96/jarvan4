...
function resolveMentionPatterns(cfg: Jar4Config | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: Jar4Config | undefined, agentId?: string): RegExp[] {
