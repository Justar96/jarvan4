...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@jar4", { botUsername: "jar4" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@jar4 args", {
        botUsername: "jar4",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "jar4" })).toBe(
      "/help@otherbot",
    );
  });
