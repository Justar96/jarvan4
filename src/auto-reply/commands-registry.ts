import type { Jar4Config } from "../config/types.js";
...
export function isCommandEnabled(cfg: Jar4Config, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: Jar4Config): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: Jar4Config): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: Jar4Config) {
