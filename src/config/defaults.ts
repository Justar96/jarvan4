...
function resolveAnthropicDefaultAuthMode(cfg: Jar4Config): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: Jar4Config): Jar4Config {
...
export function applyTalkApiKey(config: Jar4Config): Jar4Config {
...
export function applyModelDefaults(cfg: Jar4Config): Jar4Config {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: Jar4Config): Jar4Config {
...
export function applyLoggingDefaults(cfg: Jar4Config): Jar4Config {
...
export function applyContextPruningDefaults(cfg: Jar4Config): Jar4Config {
...
export function applyCompactionDefaults(cfg: Jar4Config): Jar4Config {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
