...
export const A2UI_PATH = "/__jar4__/a2ui";
export const CANVAS_HOST_PATH = "/__jar4__/canvas";
export const CANVAS_WS_PATH = "/__jar4/ws";
...
(() => {
  ...
  const handlerNames = ["jar4CanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.Jar4 = globalThis.Jar4 ?? {};
  globalThis.Jar4.postMessage = postToNode;
  globalThis.Jar4.sendUserAction = sendUserAction;
  globalThis.jar4PostMessage = postToNode;
  globalThis.jar4SendUserAction = sendUserAction;
  globalThis.jar4PostMessage = postToNode;
  globalThis.jar4SendUserAction = sendUserAction;
