...
export async function updateConfig(
  mutator: (cfg: Jar4Config) => Jar4Config,
): Promise<Jar4Config> {
...
export function resolveModelTarget(params: { raw: string; cfg: Jar4Config }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: Jar4Config): Set<string> {
