...
export function applyZaiConfig(cfg: Jar4Config): Jar4Config {
...
export function applyOpenrouterProviderConfig(cfg: Jar4Config): Jar4Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: Jar4Config): Jar4Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: Jar4Config): Jar4Config {
...
export function applyOpenrouterConfig(cfg: Jar4Config): Jar4Config {
...
export function applyMoonshotProviderConfig(cfg: Jar4Config): Jar4Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: Jar4Config): Jar4Config {
...
export function applyKimiCodeProviderConfig(cfg: Jar4Config): Jar4Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: Jar4Config): Jar4Config {
...
export function applySyntheticProviderConfig(cfg: Jar4Config): Jar4Config {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: Jar4Config): Jar4Config {
 ...
 */
export function applyVeniceProviderConfig(cfg: Jar4Config): Jar4Config {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: Jar4Config): Jar4Config {
