...
describe("detectLegacyWorkspaceDirs", () => {
  it("ignores ~/jar4 when it doesn't look like a workspace (e.g. install dir)", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "jar4");
  ...
  it("flags ~/jar4 when it contains workspace markers", () => {
    const home = "/home/user";
    const workspaceDir = "/home/user/clawd";
    const candidate = path.join(home, "jar4");
