...
import { type Jar4Config, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: Jar4Config): string[] {
...
export function listAgentsForGateway(cfg: Jar4Config): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: Jar4Config): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: Jar4Config; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: Jar4Config, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: Jar4Config; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: Jar4Config): {
  storePath: string;
...
export function getSessionDefaults(cfg: Jar4Config): GatewaySessionsDefaults {
