...
function resolveAvatarSource(cfg: Jar4Config, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: Jar4Config, agentId: string): AgentAvatarResolution {
