...
import type { Jar4Config, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: Jar4Config | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: Jar4Config | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "jar4-bundled";
}

export function resolveBundledAllowlist(config?: Jar4Config): string[] | undefined {
