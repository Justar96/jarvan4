...
describe("createJar4CodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createJar4CodingTools({
      config,
    ...
    const anthropicTools = createJar4CodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createJar4CodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createJar4CodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
