---
summary: "Model providers (LLMs) supported by Jar4"
read_when:
...
Jar4 can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `jar4 onboard`).
