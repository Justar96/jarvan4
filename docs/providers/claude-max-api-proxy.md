...
You can point Jar4 at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Jar4
...
- [Anthropic provider](/providers/anthropic) - Native Jar4 integration with Claude setup-token or API keys
