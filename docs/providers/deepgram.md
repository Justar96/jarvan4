...
Deepgram is a speech-to-text API. In Jar4 it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Jar4 uploads the audio file to Deepgram and injects the transcript
