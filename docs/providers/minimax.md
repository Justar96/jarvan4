---
summary: "Use MiniMax M2.1 in Jar4"
read_when:
  - You want MiniMax models in Jar4
...
Configure manually via `jar4.json`:
...
- Use `jar4 models list` and `jar4 models set minimax/MiniMax-M2.1` to switch.
...
- Running `jar4 configure` and selecting **MiniMax M2.1**, or
