---
summary: "Use Qwen OAuth (free tier) in Jar4"
read_when:
  - You want to use Qwen with Jar4
...
```bash
jar4 models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Jar4 will sync credentials
