...
read_when:
  - Setting up Zalo Personal for Jar4
...
- Install via CLI: `jar4 plugins install @jar4/zalouser`
- Or from a source checkout: `jar4 plugins install ./extensions/zalouser`
...
Approve via:
- `jar4 pairing list zalouser`
- `jar4 pairing approve zalouser <code>`
...
- On startup, Jar4 resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `jar4 channels logout --channel zalouser && jar4 channels login --channel zalouser`
