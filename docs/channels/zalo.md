...
- Install via CLI: `jar4 plugins install @jar4/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `jar4 plugins install ./extensions/zalo`
   - From npm (if published): `jar4 plugins install @jar4/zalo`
...
- Approve via:
  - `jar4 pairing list zalo`
  - `jar4 pairing approve zalo <CODE>`
...
- Example: `jar4 message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `jar4 channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `jar4 logs --follow`
