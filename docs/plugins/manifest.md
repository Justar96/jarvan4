...
read_when:
  - You are building a Jar4 plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---
# Plugin manifest (jar4.plugin.json)

Every plugin **must** ship a `jar4.plugin.json` file in the **plugin root**.
Jar4 uses this manifest to validate configuration **without executing plugin
