...
Jar4 controls a **dedicated Chrome profile** (named `clawd`, orange‑tinted UI). This is separate from your daily browser profile.
...
```bash
jar4 browser open https://x.com --browser-profile clawd --target host
```
