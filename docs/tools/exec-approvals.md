...
- **gateway host** → `jar4` process on the gateway machine
...
`~/.jar4/exec-approvals.json` directly.

CLI: `jar4 approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
