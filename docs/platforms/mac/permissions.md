...
- Same path: run the app from a fixed location (for Jar4, `dist/Jar4.app`).
...
```bash
sudo tccutil reset Accessibility com.jar4.mac
sudo tccutil reset ScreenCapture com.jar4.mac
