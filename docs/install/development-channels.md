...
Jar4 ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Jar4 also aligns
the install method:
...
When you switch channels with `jar4 update`, Jar4 also syncs plugin sources:
