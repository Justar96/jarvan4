...
This page ties together how Jar4 handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Jar4 keeps a
...
Jar4 separates the **prompt body** from the **command body**:
...
Jar4 can expose or hide model reasoning:
