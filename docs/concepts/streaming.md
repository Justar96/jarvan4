...
Jar4 has two separate “streaming” layers:
...
When block streaming is enabled, Jar4 can **merge consecutive block chunks**
...
When draft streaming is active, Jar4 disables block streaming for that reply to avoid double-streaming.
