...
You can also set `JAR4_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `jar4 config get agents.defaults.models`
...
If you can, include the relevant log tail from `jar4 logs --follow`.
