## Jar4 Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_jar4-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm jar4 gateway --port 18789 --verbose
```
